...
export default function Menu() {
  return (
    <section id="favourites" className="relative bg-noir-soft px-6 py-28 md:px-10 md:py-36">
      <motion.div
      ...
      <p className="mx-auto mt-14 max-w-xl text-center text-xs text-cream-dim/60">
        Plus shots, bar snacks, wine &amp; a full spirits list at the bar. Ask
        about our happy hour. Menu &amp; prices correct at time of writing
        &mdash; always check pepperrocks.co.uk for the latest.
      </p>
    </section>
  );
}
